...
import com.algebra.soccernewtry.shareCode.database.ShareCodeDao
...
@Database(entities = [Player::class, History::class, StateOfActivity::class, Match::class, MatchFlow::class, MatchPlayer::class, ShareCode::class], version = 4, exportSchema = false)
abstract class AppDatabaseAllPlayers: RoomDatabase() {
    ...
    abstract fun shareCodeDao(): ShareCodeDao
}